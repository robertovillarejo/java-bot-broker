...
public class FbBot extends Bot {
    ...
    @Autowired
    public FbBot(NlpService nlpService) {
    ...
    // * @param event
    // */
    // @Controller(events = { EventType.MESSAGE, EventType.POSTBACK }, pattern =
    // "^(?i)(hi|hello|hey)$")
    // public void onGetStarted(Event event) {
    // // quick reply buttons
    // Button[] quickReplies = new Button[] { new
    // Button().setContentType("text").setTitle("Sure").setPayload("yes"),
    // new Button().setContentType("text").setTitle("Nope").setPayload("no") };
    // reply(event,
    // new Message().setText("Hello, I am JBot. Would you like to see
    // more?").setQuickReplies(quickReplies));
    // }
    //
    // /**
    ...
    //
    // /**
    // * This method is invoked when the user types "Show Buttons" or something
    // which
    ...
    // new
    // Button().setType("web_url").setUrl("http://blog.ramswaroop.me").setTitle("JBot
    // Docs"),
    // new
    // Button().setType("web_url").setUrl("https://goo.gl/uKrJWX").setTitle("Buttom
    // Template") };
    // reply(event, new Message().setAttachment(new
    // Attachment().setType("template").setPayload(
    // new Payload().setTemplateType("button").setText("These are 2 link
    ...
    // * @param event
    // */
    // @Controller(events = EventType.MESSAGE, pattern = "(?i)(bye|tata|ttyl|cya|see
    // you)")
    // public void showGithubLink(Event event) {
    // reply(event,
    // new Message().setAttachment(new Attachment().setType("template")
    // .setPayload(new Payload().setTemplateType("button").setText("Bye. Happy
    // coding!")
    // .setButtons(new Button[] { new Button().setType("web_url").setTitle("View
    // code")
    ...
    // * of the next method to be invoked in {@code next}. This method is the
    // starting
    // * point of the conversation (as it calls
    // * {@link Bot#startConversation(Event, String)} within it. You can chain
    // methods
    ...
    // reply(event, "Cool! At what time (ex. 15:30) do you want me to set up the
    // meeting?");
    // }
    //
    // /**
    // * This method will be invoked after {@link FbBot#setupMeeting(Event)}. You
    // need
    ...
    // reply(event,
    // "Your meeting is set at " + event.getMessage().getText() + ". Would you like
    // to repeat it tomorrow?");
    // nextConversation(event); // jump to next question in conversation
    // }
    //
    // /**
    // * This method will be invoked after {@link FbBot#confirmTiming(Event)}. You
    // can
    ...
    // nextConversation(event); // jump to next question in conversation
    // } else {
    // reply(event, "No problem. You can always schedule one with 'setup meeting'
    // command.");
    ...
    //
    // /**
    // * This method will be invoked after {@link FbBot#askTimeForMeeting(Event)}.
    // You
